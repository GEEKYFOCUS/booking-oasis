...
async function createBookings() {
  // Bookings need a guestId and a cabinId.
  // We can't tell Supabase IDs for each object,
  ...
  //cabinIds, and then replace the original IDs in the booking data with the actual
  //ones from the DB
